...
public class CannyEdgeDetecor extends AbstractEdgeDetector {

    private static final double CANNY_THRESHOLD_RATIO = 2.0; //Suggested range .2 - .4
    private static final int CANNY_STD_DEV = 3;
    public CannyEdgeDetecor(BufferedImage bufferedImage) {
        super(bufferedImage);
    }

    @Override
    public void draw() {
        BufferedImage edges = cannyEdges(CANNY_STD_DEV, CANNY_THRESHOLD_RATIO);
     ...
     */
    public  BufferedImage cannyEdges( int numberDeviations, double fract) {
        int[][] raw = null;
        int[][] blurred = null;
